    ...
    public static class DbInitializer
    {
        public static void Initialize(WebStoreContext context)
        {
            ...
            using (var trans = context.Database.BeginTransaction())
            {
                ...
                context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT [dbo].[Categories] ON");
                context.SaveChanges();
                context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT [dbo].[Categories] OFF");
                trans.Commit();
            }
            ...
            using (var trans = context.Database.BeginTransaction())
            {
                ...
                context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT [dbo].[Brands] ON");
                context.SaveChanges();
                context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT [dbo].[Brands] OFF");
                trans.Commit();
            }
            ...
            using (var trans = context.Database.BeginTransaction())
            {
                ...
                context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT [dbo].[Products] ON");
                context.SaveChanges();
                context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT [dbo].[Products] OFF");
                trans.Commit();
            }
        }
        ...
        {
            if (roleManager != null && !roleManager.RoleExistsAsync(roleName).Result)
